...
<div class="dashboard-wrapper">
  <form action="app/new-ad.php" method="POST" autocomplete="off" onsubmit="var text = document.getElementById('minle').value; if(text.length < 30) { alert('Short description should be not less than 108 Characters'); return false; } return true;">
